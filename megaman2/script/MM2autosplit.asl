// https://raw.githubusercontent.com/Coltaho/Autosplitters/master/MegaMan2/MM2autosplit.asl
...
state("fceux64", "2.6.5")
{
    byte bosshp : 0x4D5150, 0x6C1;
    byte myhp : 0x4D5150, 0x6C0;
    byte mylives : 0x4D5150, 0xA8;
    byte mytitlescreen : 0x4D5150, 0x04B0;
    byte mycontroller : 0x4D5150, 0x0025;
    byte soundfx : 0x4D5150, 0xE2; //0xF1 to 0x35 is boss kill then teleport except for wily machine
    byte stage : 0x4D5150, 0x2A; //12 is boss rush, 13 is alien
}
